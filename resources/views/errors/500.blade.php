<x-guest-layout>
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-slate-50 dark:bg-slate-950">
        ...
        <div class="absolute top-1/4 left-1/4 w-96 h-96 bg-slate-500/10 dark:bg-slate-500/20 rounded-full blur-3xl pointer-events-none"></div>
        ...
        <div class="max-w-md w-full text-center relative z-10 animate-fade-in-up">
            <div class="text-9xl font-black font-display text-slate-200 dark:text-slate-800 tracking-tight select-none">
                500
            </div>
            ...
            <p class="mt-3 text-base text-slate-500 dark:text-slate-400">
                Whoops, something unexpected happened on our servers. We've been notified and are looking into it.
            </p>
