<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-2xl text-slate-800 leading-tight flex items-center gap-2" style="font-family: 'Outfit', sans-serif;">
            <i class="fa-solid fa-tags text-purple-500"></i> Edit Category
        </h2>
    </x-slot>
    <div class="py-8">
                ...
                <form method="POST" action="{{ route('categories.update', $category) }}">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <x-input id="name" name="name" type="text" class="mt-1 block w-full" :value="$category->name" required />
                        </div>
                        <div>
                        ...
                        <div class="flex justify-end gap-3">
                            ...
                            <button type="submit" class="px-6 py-3 bg-purple-500 text-white rounded-xl font-bold hover:bg-purple-600 transition shadow-lg shadow-purple-500/20"><i class="fa-solid fa-check mr-2"></i> Update Category</button>
                        </div>
                    </div>
                </form>
            </div>
